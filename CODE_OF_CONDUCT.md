...
possible violation, email the DeepFinder maintainers at
[conduct@nadav.com.cn](mailto:conduct@nadav.com.cn).
...
1. **Warning**
   1. _Event:_ A violation involving a single incident or series of incidents.
   2. _Consequence:_ A private, written warning from the Community Moderators.
   3. _Repair:_ Examples of repair include a private written apology,
      acknowledgement of responsibility, and seeking clarification on
      expectations.
2. **Temporarily Limited Activities**
   1. _Event:_ A repeated incidence of a violation that previously resulted in
      a warning, or the first incidence of a more serious violation.
   2. _Consequence:_ A private, written warning with a time-limited cooldown
   ...
   3. _Repair:_ Examples of repair may include making an apology, using the
...
3. **Temporary Suspension**
   1. _Event:_ A pattern of repeated violation which the Community Moderators
      have tried to address with warnings, or a single serious violation.
   2. _Consequence:_ A private written warning with conditions for return from
      ...
      actions.
   3. _Repair:_ Examples of repair include respecting the spirit of the
...
4. **Permanent Ban**
   1. _Event:_ A pattern of repeated code of conduct violations that other
   ...
   2. _Consequence:_ Access to all community spaces, tools, and communication
   ...
   3. _Repair:_ There is no possible repair in cases of this severity.
...
Source][ethical-source] and licensed under [CC BY-SA 4.0][cc-by-sa]. For
answers to common questions about Contributor Covenant, see the
[FAQ][FAQ]. Translations are provided at
[https://www.contributor-covenant.org/translations][translations]. The
