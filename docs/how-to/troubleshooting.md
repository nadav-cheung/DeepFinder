...
3. **Force a rebuild** -- `deepfinder daemon rebuild` wipes the on-disk cache and starts a fresh scan. This resolves most stuck-index scenarios.
...
If this didn't help, download the DMG directly from [GitHub Releases](https://github.com/nadav/DeepFinder/releases), or [open an issue](../SUPPORT.md) and include your daemon status (`deepfinder daemon status`) and any error output.
