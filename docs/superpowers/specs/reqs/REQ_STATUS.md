...
## v3.2 -- Search UI Refinement (37 REQs, all done)
...
|--------|-------------|--------|-------------|-------|
| REQ-3.2-04 | Spinner only for AI queries | done | `Sources/GUI/SearchViewModel.swift`, `Sources/GUI/SearchPanelView.swift` | Local queries <50ms show no spinner |
...
| REQ-3.2-02 | Search history dropdown | done | `Sources/GUI/SearchPanelView.swift`, `Sources/GUI/SearchViewModel.swift` | ↑ key toggle, HistoryStore, dropdown state |
...
| REQ-3.2-37 | BottomActionBar | done | `Sources/GUI/KeyboardHintBar.swift` | 6 hints including ⌘I 详情 |
...
| REQ-3.2-15 | 20pt icons + directory badge | done | `Sources/GUI/ResultRowView.swift` | 20pt icons + folder.fill badge overlay |
