...
> **Status**: ✅ Complete (tagged v2.1.0). All 7 REQs implemented.
...
- [x] **Step 2: Run test — should fail (type not found)**
...
- [x] **Step 3: Modify FileRecord to add optional metadata field**
...
- [x] **Step 4: Add metadata filter cases to SearchFilter**
...
- [x] **Step 5: Add metadata filter parsing to FilterPipeline**
...
- [x] **Step 1: Add metadata column to schema**

Add `metadata_json TEXT` column to the file_records table. Bump schema version to 2 and add migration.

- [x] **Step 2: Update saveRecords and loadAllRecords to handle metadata**

Encode `metadata` as JSON string when saving, decode when loading.

- [x] **Step 3: Add saveMetadataBatch / loadAllMetadata methods**

- [x] **Step 4: Run ALL tests (435 + new)**
...
- [x] **Step 1: Update VERSION to 2.1.0**
